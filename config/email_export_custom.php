...
try {
    ...
    $mail->Password   = 'kjyj krfm rkbk qms'; // App password
    $mail->SMTPSecure = 'tls';
    $mail->Port       = 587;
    ...
    ?>
      ...
      <body>
        <div class="export-success-box">
          ...
          <p class="export-success-message">The Job Order reports will be <strong>emailed</strong> to <em>activemediaprint@gmail.com</em>.</p>
